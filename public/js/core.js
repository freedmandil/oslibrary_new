...
Backbone.ajax = function (options) {
  ...
  options.error = function (jqXHR, textStatus, errorThrown) {
    if (jqXHR.status === 401) {
      ...
      // Handle other errors
      Utils.sendMessage('toast', 'error', 'There was an error with this request. Error Code: ' + textStatus + '(' + jqXHR + '). ' + errorThrown + '. Please try again.');
      if (originalError) {
...
/******/ 	__webpack_require__("./node_modules/backbone/backbone.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/init.js");
/******/ 	
/******/ })()
;