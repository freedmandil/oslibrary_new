<x-guest-layout>
    <div class="container">
        <div class="row justify-content-center bg-light">
            <div class="col-md-8">
                    <form method="POST" action="{{ route('register') }}" class="bg-white rounded-5 p-5 m-5">
                            @csrf
                        ...
                        <div class="row mt-4 pt-4">
                                    <!-- First Name -->
                                    <div class="col mb-3">
                                        <x-input-label for="first_name" :value="__('First Name')" class="input_label" />
                                    ...
                                    <!-- Last Name -->
                                    <div class="col mb-3">
                                        <x-input-label for="last_name" :value="__('Last Name')" class="input_label" />
                            ...
                            <div class="row">
                                    <!-- Alternative Name -->
                                    <div class="col mb-3">
                                        <x-input-label for="alt_name" :value="__('Alternative Name')" class="input_label" />
                            ...
                            <div class="row">
                                    ...
                                    <!-- Phone Number 1 -->
                                    <div class="col mb-3">
                                        <x-input-label for="phone1" :value="__('Phone Number 1')" class="input_label" />
                            ...
                            <div class="row">
                                    <!-- Email 2 -->
                                    <div class="col mb-3">
                                        <x-input-label for="email2" :value="__('Secondary Email')"  class="input_label" />
                                    ...
                                    <!-- Phone Number 2 -->
                                    <div class="col mb-3">
                                        <x-input-label for="phone2" :value="__('Phone Number 2')" class="input_label" />
                            ...
                            <div class="row">
                                    <!-- Address 1 -->
                                    <div class="col mb-3">
                                        <x-input-label for="address1" :value="__('Address 1')" class="input_label" />
                                    ...
                                    <!-- Address 2 -->
                                    <div class="col mb-3">
                                        <x-input-label for="address2" :value="__('Address 2')" class="input_label" />
                            ...
                            <div class="row">
                                    <!-- Address 3 -->
                                    <div class="col mb-3">
                                        <x-input-label for="address3" :value="__('Address 3')" class="input_label" />
                                    ...
                                    <!-- City -->
                                    <div class="col mb-3">
                                        <x-input-label for="city" :value="__('City')" class="input_label" />
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    <!-- Country -->
                                        <x-input-label for="country_id" :value="__('Country')" class="input_label" />
                                    ...
                                    <!-- State -->
                                    <div class="col mb-3">
                                        <x-input-label for="state" :value="__('State/Province')" class="input_label"  />
                                ...
                                <div class="row">
                                    <!-- ZIP/Post Code -->
                                    <div class="col mb-3">
                                        <x-input-label for="zip_post_code" :value="__('ZIP/Post Code')" class="input_label" />
                                ...
                                <!-- User Type -->
                                    <div class="col mb-3">
                                        <x-input-label for="cat_id" :value="__('Category')" class="input_label" />
